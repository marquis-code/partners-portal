...
export const usePayslip = () => {
  ...
  return { loading, selectedMonth, selectedYear, previewPdf, fetchPayslip, payslipData, firstPageData, otherPagesData, months, generatedPdfs, onPreviewPdf, activePdf, saveFile, num_of_other_pages, netRevenue, totalDeductions, totalRevenue, rowPerPage }
}
