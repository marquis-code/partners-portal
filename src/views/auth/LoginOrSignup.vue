<template>
  ...
  <div class="max-w-xl lg:max-w-2xl lg:w-3/6">
      ...
      <p @click="$emit('goToLogin')" class="block cursor-pointer mt-10 border rounded-lg border-sh-grey-900 text-sh-grey-900 font-bold text-sm w-full py-3 text-center">
        Login
      </p>
      <p @click="$emit('goToSignUp')" class="hover:bg-sh-green-600 block cursor-pointer mt-4 rounded-lg border border-transparent text-sh-grey-900 font-bold bg-sh-green-500 text-sm w-full py-3 text-center">
